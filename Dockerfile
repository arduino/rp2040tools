...
RUN apt-get update && \
    apt-get install -y curl tar cmake build-essential git wget p7zip-full pkg-config &&\
...
# i686-ubuntu12.04-linux-gnu-gcc
ENV PATH=/opt/i686-ubuntu12.04-linux-gnu/bin/:$PATH
# x86_64-ubuntu12.04-linux-gnu-gcc
